		...
		<main id="js-page-content" role="main" class="page-content">
			...
			<div class="subheader">
				<h1 class="subheader-title">
					<i class='subheader-icon fal fa-table'></i> DataTables: <span class='fw-300'>ColumnFilter</span> <sup class='badge badge-primary fw-500'>ADDON</sup>
					<small>
...
<script>
	export default {
		name: "columnfilter",
		head: {
			titleTemplate: 'DataTables: ColumnFilter | %s',
			link: [
			...
			script: [
				...
				{ src: '/assets/js/pages/datatables_columnfilter.js', type: 'text/javascript', body: true },
			]
		}
	}
</script>
