		...
		<main id="js-page-content" role="main" class="page-content">
			...
			<div class="subheader">
				<h1 class="subheader-title">
					<i class='subheader-icon fal fa-table'></i> DataTables: <span class='fw-300'>Export</span> <sup class='badge badge-primary fw-500'>ADDON</sup>
					<small>
						Export datatables to PDF, Excel, and CSV formats - without any hassle!
					</small>
				</h1>
			</div>
			<div class="row">
...
<script>
	export default {
		name: "export",
		head: {
			titleTemplate: 'DataTables: Export | %s',
			link: [
				{ rel: 'stylesheet', media: 'screen, print', href: '/assets/css/datagrid/datatables/datatables.bundle.css' },
				{ rel: 'stylesheet', media: 'screen, print', href: '/assets/css/fa-solid.css' },
			],
			script: [
				{ src: '/assets/js/datagrid/datatables/datatables.bundle.js', type: 'text/javascript', body: true },
				{ src: '/assets/js/datagrid/datatables/datatables.export.js', type: 'text/javascript', body: true },
				{ src: '/assets/js/pages/datatables_export.js', type: 'text/javascript', body: true },
			]
		}
	}
</script>
