	...
	<no-ssr>
		<main id="js-page-content" role="main" class="page-content">
			<ol class="breadcrumb page-breadcrumb">
				...
				<li class="breadcrumb-item active">RowGroup</li>
...
<script>
	export default {
		name: "rowgroup",
		head: {
			titleTemplate: 'DataTables: RowGroup | %s',
			link: [
			...
			script: [
				...
				{ src: '/assets/js/pages/datatables_rowgroup.js', type: 'text/javascript', body: true },
			]
		}
	}
</script>
