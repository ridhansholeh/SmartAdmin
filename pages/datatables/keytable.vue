		...
		<main id="js-page-content" role="main" class="page-content">
			...
			<div class="subheader">
				<h1 class="subheader-title">
					<i class='subheader-icon fal fa-table'></i> DataTables: <span class='fw-300'>KeyTable</span> <sup class='badge badge-primary fw-500'>ADDON</sup>
					<small>
...
<script>
	export default {
		name: "keytable",
		head: {
			titleTemplate: 'DataTables: KeyTable | %s',
			link: [
			...
			script: [
				...
				{ src: '/assets/js/pages/datatables_keytable.js', type: 'text/javascript', body: true },
			]
		}
	}
</script>
