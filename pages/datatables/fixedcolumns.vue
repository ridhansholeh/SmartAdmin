	...
	<no-ssr>
		<main id="js-page-content" role="main" class="page-content">
			<ol class="breadcrumb page-breadcrumb">
				...
				<li class="breadcrumb-item active">FixedColumns</li>
				<li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
			</ol>
			<div class="subheader">
				<h1 class="subheader-title">
					<i class='subheader-icon fal fa-table'></i> DataTables: <span class='fw-300'>FixedColumns</span> <sup class='badge badge-primary fw-500'>ADDON</sup>
					<small>
...
<script>
	export default {
		name: "fixedcolumns",
		head: {
			titleTemplate: 'DataTables: FixedColumns | %s',
			link: [
			...
			script: [
				...
				{ src: '/assets/js/pages/datatables_fixedcolumns.js', type: 'text/javascript', body: true },
			]
		}
	}
</script>
