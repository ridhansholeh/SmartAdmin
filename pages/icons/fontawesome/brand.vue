...
<script>
	export default {
		name: "brand",
		head: {
			titleTemplate: 'Font Awesome 5: Brand | %s',
			link: [
				{ rel: 'stylesheet', media: 'screen, print', href: '/assets/css/fa-brands.css' },
			],
			script: [
				{ src: '/assets/js/pages/icons_fontawesome_brand.js', type: 'text/javascript', body: true },
			]
		}
	}
</script>
