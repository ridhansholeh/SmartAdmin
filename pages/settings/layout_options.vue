		...
		<div class="row">
			...
			<div class="col-lg-12 col-xl-6">
				<div id="panel-20" class="panel">
					<div class="panel-hdr">
						<h2>
							RTL <span class="fw-300"><i>Support (coming soon)</i></span>
						</h2>
						<div class="panel-toolbar">
							<span class="badge badge-primary fw-300 ml-1">GLOBAL</span>
						</div>
						...
						<div class="panel-content">
							...
							<div class="row">
								...
								<div class="col-12 mb-g">
									<strong>App Usage</strong>
									<br>
									<code>data-action="toggle" data-class="theme-rtl"</code>
								</div>
							</div>
							<a href="#" onclick="return false;" class="btn btn-switch m-0 disabled"></a>
						</div>
					</div>
				</div>
			</div>
