	...
	export default {
		...
		head: {
			...
			script: [
				...
				{ src: '/assets/js/statistics/peity/peity.bundle.js', type: 'text/javascript', body: true },
				...
				{ src: '/assets/js/statistics/demo-data/dashboard_marketing.js', type: 'text/javascript', body: true },
			]
		}
	}
</script>
