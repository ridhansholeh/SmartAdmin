			...
			<div class="d-flex flex-start w-100">
				...
				<div class="d-flex flex-fill">
					<div class="flex-fill">
						...
						<br>
						<br>
						Find more facts and uses at the bootstrap <a href="https://getbootstrap.com/docs/4.3/components/dropdowns/" target="_blank">official documentation</a>.
					</div>
				</div>
			</div>
		</div>
						...
						<div class="panel-content">
							<div class="demo demo-no-mb">
								<div class="btn-group">
									...
									<div class="dropdown-menu p-4 text-muted" style="max-width: 200px; background-image: url(/assets/img/backgrounds/bg-4.png);">
										<p>
								...
								<div class="btn-group">
									...
									<div class="dropdown-menu dropdown-lg" style="background-image: url(/assets/img/backgrounds/bg-1.png);">
