			...
			<div class="d-flex flex-start w-100">
				...
				<div class="d-flex flex-fill">
					<div class="flex-fill">
						...
						<br>
						<br>
						Learn more about this plugin on bootstrap's <a href="https://getbootstrap.com/docs/4.3/components/collapse/#accordion-example" target="_blank">official documentation</a>.
					</div>
				</div>
			</div>
		</div>
								...
								<div class="card">
									<div class="card-header">
										<div class="card-title collapsed" data-toggle="collapse" data-target="#js_demo_accordion-6b" aria-expanded="false">
											<div class="d-flex flex-row align-items-center">
												<span class="mr-2">
													<img src="/assets/img/demo/avatars/avatar-j.png" class="rounded-circle profile-image" alt="Jessica Milano">
												</span>
												<div class="info-card-text">
