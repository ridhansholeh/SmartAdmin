			...
			<div class="d-flex flex-start w-100">
				...
				<div class="d-flex flex-fill">
					<div class="flex-fill">
						...
						<br>
						<br>
						Learn more about this plugin on bootstrap's <a href="https://getbootstrap.com/docs/4.3/components/spinners/" target="_blank">official documentation</a>.
					</div>
				</div>
			</div>
		</div>
