							...
							<div class="panel-content">
								...
								<nav class="navbar navbar-light bg-light">
									<a class="navbar-brand d-flex align-items-center fw-500" href="#">
										<img src="/assets/img/logo.png" class="d-inline-block align-top mr-2" alt="logo"> SmartAdmin
									</a>
								</nav>
							</div>
						</div>
								...
								<nav class="navbar navbar-expand-lg navbar-light bg-light">
									...
									<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
										...
										<a href="#" data-toggle="dropdown" title="drlantern@gotbootstrap.com" class="d-flex align-items-center justify-content-center ml-2">
											<img src="/assets/img/demo/avatars/avatar-admin.png" class="profile-image profile-image-md rounded-circle" alt="drlantern@gotbootstrap.com">
