			...
			<div class="d-flex flex-start w-100">
				...
				<div class="d-flex flex-fill">
					<div class="flex-fill">
						...
						<a href="https://getbootstrap.com/docs/4.3/utilities/spacing/" target="_blank">official documentation</a> also on this <a href="https://codepen.io/nextgenadmin/pen/VRExxJ" target="_blank">codepen example</a>
					</div>
				</div>
			</div>
		</div>
