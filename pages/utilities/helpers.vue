						...
						<div class="panel-container show">
							<div class="panel-content">
								...
								<div>
									...
									<img src="/assets/img/demo/ng.jpg" class="rounded-circle width-3 h-auto opacity-5" id="js_opacity" alt="">
								</div>
							</div>
						</div>
					</div>
...
<script>
	export default {
		name: "helpers",
		head: {
			titleTemplate: 'Helpers | %s',
			script: [
				{ src: '/assets/js/pages/utilities_helpers.js', type: 'text/javascript', body: true },
			]
		}
	}
</script>
