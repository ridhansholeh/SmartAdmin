								...
								<div class="row">
									<div class="col-xl-12">
										...
										<h5 class="frame-heading">Configuration
											<small>
												Pace is fully automatic, no configuration is necessary to get started. If you would like to make some tweaks, here's how. You can set <code>window.paceOptions</code> before bringing in the file:
											</small>
										</h5>
										<div class="frame-wrap">
...
paceOptions = {
  ...
  restartOnRequestAfter: false
										...
										<div class="frame-wrap">
											<pre class="prettyprint">&lt;script data-pace-options='{ "ajax": false }' src='pace.js'&gt;&lt;/script&gt;</pre>
										</div>
									</div>
								</div>
							</div>
