				...
				<div class="col-xl-6">
					<div id="panel-2" class="panel">
						...
						<div class="panel-container show">
							<div class="panel-content">
								<div class="panel-tag">
									The example below we use <code>color: myapp_get_color.primary_700</code>, <code>size: '20px'</code>, <code>height: '300px'</code>, <code>alwaysVisible: true</code>
								</div>
								<div class="demo-window rounded mb-g shadow-1 m-auto" style="max-width:550px">
									<div class="demo-window-content h-100">
	...
	export default {
		...
		head: {
			...
			script: [
				...
				{ src: '/assets/js/pages/plugin_slimscroll.js', type: 'text/javascript', body: true },
			]
		}
	}
</script>
