						...
						<div class="panel-container show">
							<div class="panel-content">
								...
								<figure class="figure my-4">
									<img src="/assets/img/demo/throttle.png" class="figure-img img-fluid rounded" alt="throttle">
									<figcaption class="figure-caption">Throttled with no_trailing specified as false or unspecified.</figcaption>
								</figure>
								<figure class="figure my-4">
									<img src="/assets/img/demo/throttle-no_trailing.png" class="figure-img img-fluid rounded" alt="throttle-no_trailing">
								...
								<figure class="figure my-4">
									<img src="/assets/img/demo/debounce.png" class="figure-img img-fluid rounded" alt="debounce">
									<figcaption class="figure-caption">Debounced with at_begin specified as false or unspecified</figcaption>
								</figure>
								<figure class="figure my-4">
									<img src="/assets/img/demo/debounce-at_begin.png" class="figure-img img-fluid rounded" alt="debounce-no_trailing">
						...
						<div class="panel-container show">
							<div class="panel-content">
								<table class="table table-bordered mb-g">
									<thead>
										<tr>
											<th style="width: 8rem">Arguments</th>
											<th>Description</th>
										</tr>
									</thead>
									<tbody>
...
<script>
	export default {
		name: "throttle",
		head: {
			titleTemplate: 'Throttle | %s',
			link: [
				{ rel: 'stylesheet', media: 'screen, print', href: '/assets/css/theme-demo.css' },
			],
			script: [
				{ src: 'https://cdn.rawgit.com/google/code-prettify/master/loader/run_prettify.js', type: 'text/javascript', body: true },
			]
		}
	}
</script>
