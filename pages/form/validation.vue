			...
			<div class="d-flex flex-start w-100">
				...
				<div class="d-flex flex-fill">
					<div class="flex-fill">
						...
						Learn more about forms on bootstrap's <a href="https://getbootstrap.com/docs/4.3/components/forms/#how-it-works" target="_blank">official documentation</a>
					</div>
				</div>
			</div>
		</div>
...
<script>
	export default {
		name: "validation",
		head: {
			titleTemplate: 'Form Validation | %s',
			script: [
				{ src: '/assets/js/pages/form_validation.js', type: 'text/javascript', body: true },
			]
		}
	}
</script>
