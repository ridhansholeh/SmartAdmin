								...
								<div class="form-group mb-0">
									<div class="row">
										...
										<div class="col-6 text-right">
											<nuxt-link :to="{ name: 'utilities-responsive_grid' }" title="Responsive Grid">Check out how it works</nuxt-link>
										</div>
									</div>
									<div class="row">
										<div class="col-3">
							...
							<div class="row">
								...
								<div class="col-lg-3">
									<div class="form-group">
										...
										<input type="text" id="example-input-material" class="form-control form-control-lg rounded-0 border-top-0 border-left-0 border-right-0 px-0" placeholder="Material">
									</div>
								</div>
								<div class="col-lg-3">
									<div class="form-group">
...
<script>
	export default {
		name: "basic_inputs",
		head: {
			titleTemplate: 'Basic Inputs | %s',
			script: [
				{ src: '/assets/js/pages/form_basic_inputs.js', type: 'text/javascript', body: true },
			]
		}
	}
</script>
